...
class SignUp extends React.Component {
  constructor(props) {
    const defaults = {
      email: '', firstName: '', lastName: '', password: '', password2: '', mobileNo: ''
    };
  ...
  validateField(fieldName) {
    ...
    switch (fieldName) {
      ...
      case 'lastName':
        ...
        break;
      case 'mobileNo':
        valid = value.match(/^([0|+[0-9]{1,5})?([7-9][0-9]{9})$/i);
        formErrors.mobileNo = valid ? '' : 'Mobile no is invalid';
        break;
      case 'password':
        ...
        <div className="card-body">
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                className={`form-control ${this.errorClass(formErrors.mobileNo)}`}
                id="mobileNo"
